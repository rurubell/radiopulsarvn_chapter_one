...
label day_01:
    ...
    "Я пересказал историю, которую слышал от дяди Ватанабэ, и в конце рассказа добавил:" #доделать: разобраться, двоеточия всё-таки ставить или точки. не тут, везде
