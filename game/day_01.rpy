...
label day_01:
    ...
    "Он пил «по-настоящему». Мои нынешние пивные посиделки — капля в море водки, которое выпил дядя Сато. "
    ...
    "Ну а если нет, наверняка в комнате отца и тёти Наоки должно что-то остаться. "
    ...
    "Мне нужно было в комнату отца и тёти Наоки! Это комната на первом этаже, соседняя с кухней. "
