...
label day_01:
    ...
    "Правда, в таком состоянии в общественный бассейн меня не пустят. Я вздохнул и отхлебнул еще пива."
    ...
    "Я отошел подальше от вентилятора и посмотрел на свою левую ладонь."
    ...
    watanabe "Он и на самом деле должен быть. Но нам, пацанам, разве прикажешь."
