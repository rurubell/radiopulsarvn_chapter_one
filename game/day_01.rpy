...
label day_01:
    ...
    watanabe "А Кайоши... Он даже был «радиопульсаром»! Он мне потом признался." #доделать: потомы
    watanabe "Узнай я в школьные годы, рожу бы ему начистил. А потом уже, так..."
