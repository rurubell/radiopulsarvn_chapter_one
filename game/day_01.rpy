...
label day_01:
    ...
    zak "Йоу, чувак!"
    kenji "Привет. Твой рисунок готов, сейчас перешлю." #доделать: повтор "рисунка" несчастного трижды подряд
    ...
    kenji "Что опять?"
    zak "Я не мог понять, чего именно хочу! Но теперь знаю!" #доделать: очень прямой смысловой и лексический повтор с прошлой его репликой ("понять, чего именно хочу")
    ...
    "Конечно, никто никуда не спешит. Отец и тётя Асука приедут ещё очень нескоро. Если вообще навестят нас до конца лета. "
    ...
    aiko "Ты чего думаешь, я в сортах пива — спец?" #доделать: нада подумать, немного режет слух
    ...
    "Но нет, она поставила пиво на подставку, забрала мою порцию супа и села напротив." #доделать: "поставила на подставку"
    ...
    "Когда банка опустела, я почувствовал, что достиг нужной кондиции и двинулся к кладовке." #доделать: "к кладовке", фоника
    ...
    "Всю левую половину кладовки занимал стеллаж, который тётя Асука планировала освободить, чтобы устроить в нём гардероб. "
    ...
    "Ещё Макото-сан тратил много денег на оборудование. Чего, конечно, не одобряла тётя Асука. "
    ...
    kenji "Да какая разница. Но сама понимаешь, народу там — тьма." #доделать: говорят о школьном бассейне же, какая тьма
    ...
    "Поход был действительно трудный! " #доделать: повтор, но вроде норм. выделить пояснее как приём что ли
    ...
    "Эх, жалко, я Айко не показал, какая эта жёлтая зараза тяжёлая. Она бы мной гордилась! "  #доделать: фоника — фиг знает как исправить но много ж
    "Пожалела бы меня и позабыла про свои придирки как минимум на месяц! И почему я такой недогадливый?" #доделать: повтор жалко—пожалела и еще одна ж
    ...
    "Она сразу же принялась изучать тележку, пытаясь определить ее состояние. "
    "Мне почему-то стало смешно от выражения её лица, когда она наконец нащупала место крепления колес. "
    ...
    blind_girl "Не знаю..."
    blind_girl "Эта тележка тёти. Я обещала, что верну её в целости."
    ...
    "Но в моей голове родился образ омерзительной старой карги, которая по возвращении девушки ухватит ее за волосы и потащит по улице, крича о жутком преступлении, которое та совершила."
    ...
    "Касуми назвала свой адрес. Это было далеко отсюда. Раз в пять дальше, чем до моего дома."
    ...
    "Черт! Мне бы больше подошёл ответ уровня «это устройство для связи с внеземными цивилизациями»."
    ...
    "Слава богу, волосы на затылке, которые по утрам стояли дыбом, теперь улеглись. Видимо, намокли от пота и потому перестали топорщиться. "
    ...
    "А так, если не брать во внимание запах алкоголя, я кажусь ей вполне обычным человеком."
    ...
    "Пока что на улице нам никто не встретился, хотя мы прошли уже больше половины пути. Здесь, думаю, уже жили люди, которые могли знать Касуми. "
    ...
    "Узнать бы у Касуми о судьбе её родителей. Но это не то, о чем может спрашивать такой малознакомый человек, как я. "
    ...
    "Я не так хорошо знал этот район города. Впрочем, я вообще мало знал окрестности вдали от дома, как и полагается порядочному хиккикомори."
    ...
    "Касуми не ответила. Вместо этого она повернулась в сторону своего дома, вытянула руки и пошла вперед. "
    
    show kasumi_01 Normal_Silent with Dissolve( my_dissolve_02 )
    
    "Как только ее ноги ступили на гравий, она положила тележку на землю и повернулась ко мне. Похоже, теперь она сориентировалась."
    ...
    watanabe "Каждый из нас их ненавидел, но каждый, мне кажется, моментально вступил бы к ним в клуб, появись у него такая возможность." 
    ...
    "Я ничего не понял, но дальше распрашивать не стал. Не моё это дело, знать, что там у них и как. "
    ...
    kenji "Ну, не обязательно же прямо такие. От чего другого, может, тоже подойдет?"
    ...
    "Я покатал тележку по земле. Колеса крутились, хоть и туго. "
    ...
    "Я вновь прокрутил в голове сцену встречи с ней, поход к её дому. Вспомнил, какой сдержанной была Касуми. Не помню, чтобы она весело смеялась. "
    ...
    "Я забрался в ванную. Вода невыносимо жгла обожжённые солнцем руки, и я положил их на бортики ванны. "
    ...
    "Мне очень захотелось прикоснуться к ним наяву, так же, как минуту назад в своем воображении. Или провести ладонью по её голове. "
    ...
    "В пару к джинсам я решил надеть рубашку в клетку. Рубаха была на вид бледноватой, как будто на солнце выгорела, но мне нравился ее неброский вид."
    ...
    "Кто-то даже говорил, что видел, как они целовались. Лица тех, кто слышал эту новость, невольно искажались отвращением."
    ...
    "Зачем пишут эту отвратительную заумь? Кто читает эту хрень? Неужели Касуми в этом море непонятной информации чувствует себя как рыба в воде? Как ей это удается?"
    "Может будь, есть хоть одна книга для новичков? Почему здесь только громоздкие, неподъемные для моего слабого мозга энциклопедии? "
    ...
    "Я прошерстил интернет, в попытках скачать копию этой книги, но и тут меня ожидала неудача."
    
    stop music fadeout 2

    "Раздосадованный и опустошенный, я выключил компьютер. На часах была половина первого. "
    "Я завел будильник в телефоне на десять часов, скинул с себя верхнюю одежду и лёг в кровать."
