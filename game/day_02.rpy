...
label day_02:
    ...
    "Автомат выплюнул два брикета."
    "Я подал один Касуми, а сам принялся за свой."
    "Откусывая холодные кусочки, я с неудовольствием поглядывал по сторонам."
    "Всех прохожих как ветром сдуло."
    "Не то чтобы я так хотел, чтобы люди смотрели на нас."
    "Но всё-таки!"
    "Для кого я режиссировал эту сценку?"
    "Такой момент и останется никем не замеченным."
    "Да… Такой момент…"
    "Я полез в карман штанов за телефоном."
    "Не пропадать же зря моменту."
    "Раз это никто не видит, я сделаю фотографию."
    "Неприлично, конечно, фотографировать незрячего человека против его воли."
    "Но спрашивать разрешения не хватало смелости."
    "Я оглянулся."
    "Удостоверился что свидетелей не было."
    ...
    "Я потёр экран телефона, но пятно не исчезло."
    "Я увеличил изображение."
    "На мороженном сидел огромный шмель!"

    kenji "Ой! Касуми! У тебя на мороженном сидит… Шмель!"
    kasumi "А?"

    "Касуми осторожно отвела руку с мороженным от себя."
    "Шмель по недоброму загудел, подтверждая мои слова."
    ...
    "Замахал ладонью возле шмеля, пытаясь его согнать."
    "Но чёртово насекомое и не думало улетать, а только недовольно жужжало."
    "Тогда я отвесил шмелю хороший щелбан."
    "Щелбан сработал."
    "Шмель стремительно улетел в неизвестном направлении, кувыркаясь в воздухе и обиженно жужжа."
    "К большой моей радости, обратно он не вернулся."
    ...
    "Наверное Касуми брезговала есть мороженное, на котором сидел шмель."
    "Хотя шмели и пчёлы мне казались милыми и чистоплотными животными и я их не брезговал, как мух, например."
    ...
    "Если честно, мне своё мороженное тоже ни капельки не хотелось доедать."
    "Кажется я уже окончательно пережил возраст любви к сладкому."
    "Урна для мусора обнаружилась неподалёку."
    "Я выкинул свой стаканчик."
    ...
    "Но вообще, в связи с жарой, мошки в воздух поднялось достаточно."
    "Можно было и поверить."
    ...
    "Но нет."
    "Перед нами был глухой бетонный забор, метра три высотой."
    "Металлические ворота жалюзи и кирпичная будка с дверью, окошком и домофоном."
    "Я заглянул в окошко, но в мутном стекле отражалась только улица и ничего нельзя было разобрать."
    "Тогда я нажал кнопку домофона."
    ...
    kenji "Хорошо. Надеюсь я его быстро найду."
    ...
    "Посреди комнаты стоял лысый, пожилой мужчина, вид у него был слегка напуганный."

    trash_man_01 "Я думал что Йоши пришел, этот парень у нас водителем работает… Там девчонка с тобой, да? Не понравится ей наш беспорядок…"
    kenji "Она сказала что подождёт на улице."

    "Мужчина повеселел."

    trash_man_01 "Это ладно! Вообще, в первый раз слышу, чтобы к нам кто-то обращался по такому поводу. Наверное лучше бы спросить у начальства, можем ли мы вернуть что-то обратно. Объект то у нас режимный."

    "Он взял в руки телефон и некоторое время принялся что-то рассматривать на его экране."

    trash_man_01 "А впрочем — ладно. Ты только опиши мне сначала, что ты хочешь забрать. Чтобы я точно понял, что эта вещь твоя и ты не решил забрать что-то чужое и ценное. Хотя, кто ценности выбрасывает в мусорку, правда?"

    "Я назвал приметы разыскиваемого прибора."

    trash_man_01 "Говоришь вчера выбросил? Вчера меня на работе не было, сейчас я позвоню тому парню, которого меняю, и спрошу, что да как."

    "Он набрал номер, и приготовился ждать ответа."
    "Последовала продолжительная пауза, но наконец на том конце взяли трубку."

    trash_man_01 "Эй … привет… Послушай, тут какой-то парень пришел, говорит вчера выбросил по ошибке ценную вещь… Да, на нашу площадку… Вчера должны были привезти электронику… В каком боксе? А… Нет? Не было? А… Ну ладно…"

    "Служащий мусорки закончил разговор по телефону и растеряно посмотрел на меня."

    trash_man_01 "Похоже что Йоши не привозил вчера мусор. Странно… Может он перепутал чего? Сейчас я позвоню самому Йоши, и спрошу что да как…"

    "Он опять поднёс телефон к уху и послышались гудки."
    "Вдруг, что-то ударилось в окно комнатки, которое располагалось за моей спиной."
    "Я услышал, как закричала Касуми."
    ...
    "Да и Касуми была вся облеплена такими шкурками."
    "Что это?"
    "Откуда это взялось?"
    "Я завертел головой, огладывая улицу."
