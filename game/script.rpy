...
label start:
    ...
    "А шесть лет назад он женился на вдове, Макото Асуке. С тех пор у меня появились сестра и новая мама, хотя я предпочитал называть её «тётя Асука». "
    ...
    "Возможно, потому что она стала чувствовать себя лишней. Ведь у отца и тёти Асуки появился совместный ребёнок, наш с Айко младший брат. "
    ...
    "В общем, как это обычно и бывает, жена не особо была рада увлечения мужа. "
    ...
    "Как же мне повезло с сестренкой! Мысль о предстоящем отдыхе приободрила меня, и я с энтузиазмом вернулся к работе."
    ...
    "За время моего отсутствия на площадке появился напольный вентилятор с разлохмаченными от старости синими лопастями и пожелтевшим пластиком корпуса. "
    ...
    "Я окинул взглядом и оценил вещи, который принес. Да я просто герой!"
    ...
    "Но может быть, девчонке этой надо на площадку для мусора? А я её стесняю, и поэтому она так внезапно принялась изучать эту стену?"
    ...
    "Тут мне словно врубили нужную часть мозга, и я почувствовал, что от слепой девушки просто несёт запахом сигарет. "
    ...
    "Грустно оттого, что девушка уходит, и я её, наверное, больше уже никогда не увижу."
    ...
    blind_girl "А как? Как оно выглядит? Точь-в-точь как эта? Может,д просто ещё одна?"
