...
label start:
    ...
    kenji "Что опять?"
    zak "Я не мог понять чего хочу конкретно! Но теперь знаю!" 
    ...
    "А шесть лет назад он женился на вдове, Макото Асуке. С тех пор у меня появилась сестра и новая мама, хотя я предпочитал называть её «тётя Асука». "
