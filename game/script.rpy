...
label start:
    ...
    kasumi "Я вас буду плохо вас слышать. Лучше встаньте слева."
    ...
    "У меня есть отличные джинсы для особых случаев. Им уже лет пять, не меньше, но они в отличном состоянии — так редко я их надеваю. "
