...
label start:
    ...
    "Айко была на кухне. Она нахмурилась, гляда на меня, но ничего не сказала. "
    ...
    "Я только что прикасался к прибору, который принес ранее. А до меня его, похоже, трогал чужак. "
