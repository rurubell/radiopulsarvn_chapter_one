...
label start:
    ...
    "Но видно было, что на завтрак — ничего сверхъестественного. Суп по крайней мере."
    
    aiko "На завтрак суп. А ещё я сделала салат с ветчиной."
    ...
    "С тех пор у меня появилась новая мама, хотя я предпочитал называть её «тётя Асука»."
    "Отец и тётя Асука не жили с нами. Вскоре после переезда в дом мисс Макото, отцу предложили новую работу в центре города, и жить в захолустном пригороде ему стало крайне неудобно."
