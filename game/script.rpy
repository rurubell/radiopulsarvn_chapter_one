...
label start:
    ...
    "Дело в том, что всё лежащее на полках, раньше принадлежало её бывшему мужу, Макото Кайоши."
    ...
    "Причём металл достойной толщины - судя по весу каждого. "
    ...
    "Один был значительно тяжелее другого, на его передней панели красовались чёрные стрелочные приборы, да несколько тумблеров. "
    ...
    "На обратном пути я внось никто не встретил. Довольно удачный выдался денёк! "
